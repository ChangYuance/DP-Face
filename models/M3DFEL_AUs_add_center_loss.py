...
class M3DFEL_AUs_add_center_loss(nn.Module):
    """The proposed M3DFEL_AUs_add framework
    Args:
        args
    """
    def __init__(self, args):
        super(M3DFEL_AUs_add_center_loss, self).__init__()
        self.args = args
        ...
        self.shrink = nn.Linear(1024, 128)
        self.Softmax = nn.Softmax(dim=-1)
        self.center_loss = CenterLoss(num_classes=2, feat_dim=128, device=self.device, lambda_center=0.5)
    def MIL(self, x):
