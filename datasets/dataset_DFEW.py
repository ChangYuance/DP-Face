...
class DFEWDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.args.audio:
            return images, mel_spectrogram, last_three, data["emotion"]# torch.Size([16, 3, 224, 224])
        if self.args.AUs:
            return images, AUs, last_three, data["emotion"]
        else:
            return images, last_three, data["emotion"]
