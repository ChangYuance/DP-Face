...
ROOT=/home/chang_yuance/data/changyuance/codes/TFace-master_my/attribute/M3DFEL/0107dataset_val_handmade
...
do
    ...
    $PYTHON $MAIN \
        ...
        --num_frames 2 \
        --AUs True \
        --fusionmodel M3DFEL_handmade \
        --savename M3DFEL_handmade_fold_${FOLD} \
