...
ROOT=/home/chang_yuance/data/changyuance/codes/TFace-master_my/attribute/M3DFEL/0107dataset_val_no_Wrinkle
...
do
    ...
    $PYTHON $MAIN \
        ...
        --instance_length 4 \
        --fold $FOLD \
        --fusionmodel M3DFEL_center_loss \
        --savename M3DFEL_Wrinkle_fold_${FOLD} \
        --center_loss True \
        --epochs 200
